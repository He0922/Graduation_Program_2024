...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_Flipbook = { "Flipbook", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, Flipbook), Z_Construct_UScriptStruct_FOceanologyFlipbook, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Flipbook_MetaData), NewProp_Flipbook_MetaData) }; // 4172479497
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_Foam = { "Foam", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, Foam), Z_Construct_UScriptStruct_FOceanologyFoam, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Foam_MetaData), NewProp_Foam_MetaData) }; // 248900462
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_Folding = { "Folding", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, Folding), Z_Construct_UScriptStruct_FOceanologyFolding, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Folding_MetaData), NewProp_Folding_MetaData) }; // 4152623575
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_Procedural = { "Procedural", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, Procedural), Z_Construct_UScriptStruct_FOceanologyProcedural, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Procedural_MetaData), NewProp_Procedural_MetaData) }; // 3284810262
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_Mask = { "Mask", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, Mask), Z_Construct_UScriptStruct_FOceanologyMask, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Mask_MetaData), NewProp_Mask_MetaData) }; // 1955861707
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_GGX = { "GGX", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, GGX), Z_Construct_UScriptStruct_FOceanologyGGX, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GGX_MetaData), NewProp_GGX_MetaData) }; // 149473620
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_Underwater = { "Underwater", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, Underwater), Z_Construct_UScriptStruct_FOceanologyUnderwater, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Underwater_MetaData), NewProp_Underwater_MetaData) }; // 1763236404
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewProp_BubblesSettings = { "BubblesSettings", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOceanologyWaterPresetResult, BubblesSettings), Z_Construct_UScriptStruct_FOceanologyBubblesSettings, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BubblesSettings_MetaData), NewProp_BubblesSettings_MetaData) }; // 1509862927
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Oceanology_Plugin_Source_Oceanology_Plugin_Public_Structs_OceanologyWaterPresetResult_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FOceanologyWaterPresetResult::StaticStruct, Z_Construct_UScriptStruct_FOceanologyWaterPresetResult_Statics::NewStructOps, TEXT("OceanologyWaterPresetResult"), &Z_Registration_Info_UScriptStruct_OceanologyWaterPresetResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOceanologyWaterPresetResult), 2933757707U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Oceanology_Plugin_Source_Oceanology_Plugin_Public_Structs_OceanologyWaterPresetResult_h_3647138769(TEXT("/Script/Oceanology_Plugin"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Oceanology_Plugin_Source_Oceanology_Plugin_Public_Structs_OceanologyWaterPresetResult_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Oceanology_Plugin_Source_Oceanology_Plugin_Public_Structs_OceanologyWaterPresetResult_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
